...
namespace RediensIAM.Data.Migrations
{
    ...
    [Migration("20260806163219_UserOrganisationMembership")]
    partial class UserOrganisationMembership
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RediensIAM.Data.Entities.ImpersonationSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ActorUserId", "RevokedAt");

                    b.ToTable("impersonation_sessions", (string)null);
                });

            modelBuilder.Entity("RediensIAM.Data.Entities.Instance", b =>
                {
                    ...
                    b.Property<string>("AdminSpaOrigin")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<int>("ArgonMemoryCost")
                        .HasColumnType("integer");

                    b.Property<int>("ArgonParallelism")
                        .HasColumnType("integer");

                    b.Property<int>("ArgonTimeCost")
                        .HasColumnType("integer");

                    b.Property<int>("AuditRetentionDays")
                        .HasColumnType("integer");

                    b.Property<string>("CacheInstanceName")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("EnvSnapshot")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("HydraAdminUrl")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("HydraPublicUrl")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<int>("InviteExpiryHours")
                        .HasColumnType("integer");

                    b.Property<string>("KetoReadUrl")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("KetoWriteUrl")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<int>("MaxSmsPerWindow")
                        .HasColumnType("integer");

                    b.Property<int>("OtpTtlSeconds")
                        .HasColumnType("integer");

                    b.Property<int>("PatCacheTtlMinutes")
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTimeOffset?>("ReconfiguredAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int>("SmsWindowMinutes")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RediensIAM.Data.Entities.OrgSmtpConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("org_smtp_configs", (string)null);
                });
            ...
            modelBuilder.Entity("RediensIAM.Data.Entities.Project", b =>
                {
                    ...
                    b.Property<bool>("CheckBreachedPasswords")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("RediensIAM.Data.Entities.SamlIdpConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("DisplayNameAttributeName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.ToTable("saml_idp_configs", (string)null);
                });
            ...
            modelBuilder.Entity("RediensIAM.Data.Entities.User", b =>
                {
                    ...
                    b.Property<bool>("NewDeviceAlertsEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true);
            ...
            modelBuilder.Entity("RediensIAM.Data.Entities.Webhook", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("RediensIAM.Data.Entities.WebhookDelivery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("RediensIAM.Data.Entities.OrgSmtpConfig", b =>
                {
                    b.HasOne("RediensIAM.Data.Entities.Organisation", "Organisation")
                        .WithOne()
                        .HasForeignKey("RediensIAM.Data.Entities.OrgSmtpConfig", "OrgId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RediensIAM.Data.Entities.WebhookDelivery", b =>
                {
                    b.HasOne("RediensIAM.Data.Entities.Webhook", "Webhook")
                        .WithMany("Deliveries")

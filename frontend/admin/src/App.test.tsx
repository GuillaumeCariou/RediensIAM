...
vi.mock('./pages/system/AuditLog', () => stub('AuditLog'));
...
vi.mock('./pages/system/SystemServiceAccounts', () => stub('SystemServiceAccounts'));
...
vi.mock('./pages/org/OrgServiceAccounts', () => stub('OrgServiceAccounts'));
vi.mock('./pages/org/OrgAuditLog', () => stub('OrgAuditLog'));
...
vi.mock('./pages/project/ProjectServiceAccounts', () => stub('ProjectServiceAccounts'));
